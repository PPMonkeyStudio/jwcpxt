...
public String toString() {
	return "jwcpxt_option_inquiries [jwcpxt_option_inquiries_id=" + jwcpxt_option_inquiries_id
			+ ", option_inquiries_describe=" + option_inquiries_describe + ", option_inquiries_type="
			+ option_inquiries_type + ", option_inquiries_option=" + option_inquiries_option
			+ ", option_inquiries_gmt_create=" + option_inquiries_gmt_create + ", option_inquiries_gmt_modified="
			+ option_inquiries_gmt_modified + "]";
}
