...
public String toString() {
	return "jwcpxt_user [jwcpxt_user_id=" + jwcpxt_user_id + ", user_account=" + user_account + ", user_password="
			+ user_password + ", user_name=" + user_name + ", user_unit=" + user_unit + ", user_Jurisdiction_evaluate="
			+ user_Jurisdiction_evaluate + ", user_Jurisdiction_statistics=" + user_Jurisdiction_statistics
			+ ", user_Jurisdiction_review=" + user_Jurisdiction_review + ", user_state=" + user_state
