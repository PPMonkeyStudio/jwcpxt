...
public String toString() {
	return "jwcpxt_question [jwcpxt_question_id=" + jwcpxt_question_id + ", question_describe=" + question_describe
			+ ", question_type=" + question_type + ", question_service_definition=" + question_service_definition
			+ ", question_sort=" + question_sort + ", question_gmt_create=" + question_gmt_create
