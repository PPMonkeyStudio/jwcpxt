...
public String toString() {
	return "jwcpxt_service_distribution [jwcpxt_service_distribution_id=" + jwcpxt_service_distribution_id
			+ ", service_distribution_judge=" + service_distribution_judge + ", service_distribution_service_instance="
			+ service_distribution_service_instance + ", service_distribution_gmt_create="
			+ service_distribution_gmt_create + ", service_distribution_gmt_modified="
			+ service_distribution_gmt_modified + "]";
}
