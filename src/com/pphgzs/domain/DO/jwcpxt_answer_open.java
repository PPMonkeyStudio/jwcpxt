...
public String toString() {
	return "jwcpxt_answer_open [jwcpxt_answer_open_id=" + jwcpxt_answer_open_id
			+ ", answer_open_mypcxt_service_instance=" + answer_open_mypcxt_service_instance + ", answer_open_content="
			+ answer_open_content + ", answer_open_question=" + answer_open_question + ", answer_open_gmt_create="
