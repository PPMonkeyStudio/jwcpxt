...
public String toString() {
	return "jwcpxt_service_definition [jwcpxt_service_definition_id=" + jwcpxt_service_definition_id
			+ ", service_definition_describe=" + service_definition_describe + ", service_definition_unit="
			+ service_definition_unit + ", service_definition_gmt_create=" + service_definition_gmt_create
